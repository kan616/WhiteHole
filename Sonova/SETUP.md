# Sonova - Setup & Build Instructions

This guide will help you build and run Sonova on your Mac.
...
2. **Copy source files**
   ...
   cp -r Sonova/Sources/* YourXcodeProject/Sonova/
   ```

3. **Configure entitlements**

   Add to your `Sonova.entitlements`:
   ```xml
...
4. **Update Info.plist**
   ...
   <string>Sonova needs screen recording permission to capture system audio.</string>
   ```
...
2. **Configure Bundle Identifier**
   - Use a unique bundle identifier (e.g., `com.yourname.Sonova`)
...
xcrun notarytool submit Sonova.zip \
...
2. **Recording functionality**
   ...
   - Stop recording
   - Verify file is saved to `~/Music/Sonova Recordings/`
...
Sonova is designed to be lightweight:
