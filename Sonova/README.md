...
**Sonova** is a simple, elegant macOS application for recording system audio. Built with SwiftUI and ScreenCaptureKit, it provides a clean, minimal interface for capturing system audio without requiring any external drivers.
...
- **Auto-Save**: Recordings are automatically saved to `~/Music/Sonova Recordings/`
...
2. Open `Sonova.xcodeproj` in Xcode
3. Build and run (⌘R)

```bash
git clone https://github.com/yourusername/Sonova.git
cd Sonova
open Sonova.xcodeproj
```
...
Sonova uses Apple's **ScreenCaptureKit** framework, introduced in macOS 12.3. This modern API allows applications to capture system audio directly without requiring kernel extensions or third-party audio drivers.
...
├── Sources/
│   ├── Sonova/
│   │   └── SonovaApp.swift      # App entry point
│   ├── Views/
...
Sonova requires **Screen Recording** permission to capture system audio. This is a macOS system requirement for using ScreenCaptureKit.

To grant permission:
1. Open **System Settings**
2. Go to **Privacy & Security** > **Screen Recording**
3. Enable the toggle for **Sonova**
4. Restart the app
...
Sonova is licensed under the **GNU General Public License v3.0**.
...
We chose GPL-3.0 to keep Sonova free and open-source forever. If you build upon this project, your improvements must also be shared with the community.
...
- **Issues**: [GitHub Issues](https://github.com/yourusername/Sonova/issues)
- **Discussions**: [GitHub Discussions](https://github.com/yourusername/Sonova/discussions)

## FAQ

### Why does it need Screen Recording permission?

ScreenCaptureKit is Apple's unified framework for capturing both screen and audio content. Even though Sonova only records audio, the permission is still required by macOS.
...
No, Sonova requires macOS 12.3 or later because it uses ScreenCaptureKit, which was introduced in that version.
...
*Sonova - Simple, elegant system audio recording*
